...
describe("escapeHtml", async () => {
  const { escapeHtml } = await import("../src/escape-html.js");
...
describe("prompt-builder", async () => {
  const { buildPrompt, _testExports } = await import("../src/prompt-builder.js");
  const { formatComments } = _testExports;
...
describe("sidebar", async () => {
  const { _testExports } = await import("../src/sidebar.js");
  const { threadComments, truncate, timeAgo } = _testExports;
